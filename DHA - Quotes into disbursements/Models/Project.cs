...
namespace DHA.DSTC.WPF.Models
{
    public class Project
    {
        ...
        // Reads the discipline/category OptionSet label from FormattedValues (Dataverse choice field)
        private static string SafeGetDiscipline(Entity entity)
        {
            if (entity == null) return "";
            try
            {
                // FormattedValues contains the display label for OptionSet/Choice fields
                if (entity.FormattedValues != null && entity.FormattedValues.Contains("isc_discipline"))
                    return entity.FormattedValues["isc_discipline"];
                // Fall back to raw string attribute (in case it is stored as text)
                return SafeGetString(entity, "isc_discipline", "");
            }
            catch { return ""; }
        }
        ...
        // ?? REPLACE the FromEntity method in Models/Project.cs:
        ...
        public static Project FromEntity(Entity entity)
        {
            ...
            try
            {
                ...
                project.Discipline = SafeGetDiscipline(entity);
            ...
            catch (Exception ex)
            {
                ...
                return new Project { Name = "There was an error loading project" };
            }
        }
