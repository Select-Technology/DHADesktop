    ...
    public class ProjectService
    {
        ...
        public List<Project> SearchProjects(string searchTerm)
        {
            ...
            try
            {
                ...
                // Add link to account for customer (client) name searching
                var clientLink = new LinkEntity
                {
                ...
                query.LinkEntities.Add(clientLink);
                ...
                searchGroup.AddCondition("client", "name", ConditionOperator.Like, $"%{searchTerm}%");
            ...
            {
                System.Diagnostics.Debug.WriteLine($"SearchProjects ERROR: {ex.GetType().Name} - {ex.Message}");
                System.Diagnostics.Debug.WriteLine($"SearchProjects STACK: {ex.StackTrace}");
                throw;
            }
        }
