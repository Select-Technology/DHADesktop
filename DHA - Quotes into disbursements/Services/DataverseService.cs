...
namespace DHA.DSTC.WPF.Services
{
    public class DataverseService
    {
        ...
        public async Task<List<TimeEntry>> GetTimeEntriesAsync(DateTime fromDate, DateTime toDate, Guid teamMemberId)
        {
            var columns = new ColumnSet(
                "fwp_date",
            ...
            filter.AddCondition("fwp_date", ConditionOperator.GreaterEqual, fromDate.Date);
            filter.AddCondition("fwp_date", ConditionOperator.LessEqual, toDate.Date);
